...
## What your Inheritance gives you
...
the first session is yours to write; the sheet only asks you where the training went.

> [!note] The cap still holds
...
The option is an option. Two points is exactly what one Expertise costs, so Late Bloomer pays for one
...
- **No imposed skills, no imposed tools.** The old "2 skills + 1 tool picked for you" is gone —
  those points became free, and they are yours to place.
