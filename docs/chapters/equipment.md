...
**Its properties** — what it demands of you, or allows you. Nine of them exist, and they come
in two families. Four are **demands**: *Two-Handed* takes both your hands to attack,
*Heavy* is unwieldy for Small creatures, *Loading* limits you to one shot per action however
many attacks you have, and *Ammunition* means you carry the shot and spend it. Five are
**permissions**: *Finesse* lets you choose Strength or Dexterity — for the attack and the
damage, but the same one for both; *Light* opens a second attack with another Light weapon;
*Thrown* lets you throw it with the same ability you'd swing it; *Versatile* gives a bigger
die when you take it in both hands; *Reach* adds 5 feet to your reach.
