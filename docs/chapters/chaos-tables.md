...
| Result | Consequence |
|--------|-------------|
| 1 | Passing weakness: −1 CON for 1 hour. |
| 2 | Mild nausea: disadvantage on your next CON saving throw. |
| 3 | Internal pain: −2 CON for 24 h. |
| 4 | Internal bruising: disadvantage on CON checks for 1d3 days. |
| 5 | Laboured breathing: half speed, −2 CON until a long rest. |
...
| Result | Consequence |
|--------|-------------|
| 1 | Slight confusion: −1 on WIS checks for 1 hour. |
| 2 | Headaches: disadvantage on your next WIS or Vigilance check. |
| 3 | Emotional turmoil: −2 WIS for 24 h. |
| 4 | Attention disorder: disadvantage on Vigilance/Insight for 1d3 days. |
| 5 | Insomnia: no full rest, −2 WIS until restorative sleep. |
...
| Result | Consequence |
|--------|-------------|
| 1 | Dizziness: −1 INT for 1 hour. |
| 2 | Trouble concentrating: disadvantage on your next INT check. |
| 3 | Clouded thoughts: −2 INT for 24 h. |
| 4 | Mental apathy: disadvantage on INT checks (History, Investigation) for 1d3 days. |
| 5 | Brief memory lapses: −2 INT until the next long rest. |
...
| Result | Consequence |
|--------|-------------|
| 1 | Sudden shyness: −1 CHA for 1 hour. |
| 2 | Stammering: disadvantage on your next CHA check. |
| 3 | Loss of confidence: −2 CHA for 24 h. |
| 4 | Social anxiety: disadvantage on all CHA checks for 1d3 days. |
