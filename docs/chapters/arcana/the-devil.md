...
![The Devil — Fate's Hand tarot](../../assets/img/tarot/major/XV.jpg){ .fh-card-illus }
...
| --- | --- | --- |
| 1 | **Whispered Doubt** | one creature you can see takes −1d4 on its next saving throw |
| 2 | **Chains of Desire** | *Bane* |
| 3 | **Sweet Bondage** | *Suggestion* |
| 4 | **Contract Sealed** | touch: 4d6 necrotic (CON save half), you regain half the damage dealt as HP |
| 5 | **Chains Made Flesh** | creatures in a 20-ft radius: 3d6 fire and restrained for 1 round (DEX save) |
| 6 | **Soul in Thrall** | *Dominate Person* |
