...
### Lunar Shift
Provided the moon is present in the sky, as a **Bonus Action**, spend **1 Sorcery Point** to change your lunar embodiment for **1 minute**. You gain the new moon's bonus spells and schools, but **not its boon**. **Once per long rest.**

### Lunar Connection I
With *X* = your proficiency bonus, you may exchange up to *X* spells, choosing from your lunar school within the **Wizard's spell list**. These are **not** lunar spells (they cannot be cast without a spell slot).
...
| Moon | Effect |
| --- | --- |
| **Aulmyria** | 30-ft bright light. Enemies save or are **blinded**; one ally regains **3d8 HP**. Once per long rest. |
| **Ur-Nozgul** | When casting an enchantment, target a **second creature** for free. Once per long rest. |
| **Forgon** | Use **Sculpt Spell** on all Evocation spells. Once per long rest. |
| **Trien** | Gain **40 ft land speed** and **60 ft flying speed (hover)** for 1 minute. Once per short rest. |
| **Ono** | Cast ***True Seeing*** without a spell slot. Once per long rest. |
| **Cerkato** | **Turn and sear Undead** as a cleric of your level. Once per long rest. |

### Lunar Connection II
With *X* = your proficiency bonus, you may exchange up to *X* additional spells, choosing from your lunar school within the **Wizard's spell list**.

### Lunar Shift improvement
You can now use **Lunar Shift** once per **short rest**.

## Level 18

### Lunar Harmony
**Once per long rest**, as a **Bonus Action**, enter **Lunar Harmony** for 1 minute:
