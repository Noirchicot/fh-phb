...
<h3 class="fh-pcfh__feature" id="l2-tactical-mind">Level 2: Tactical Mind</h3>
...
<h3 class="fh-pcfh__feature" id="l3-fighter-subclass">Level 3: Fighter Subclass</h3>
...
<h3 class="fh-pcfh__feature" id="l5-tactical-shift">Level 5: Tactical Shift</h3>
...
<h3 class="fh-pcfh__feature" id="l9-indomitable">Level 9: Indomitable</h3>
...
<h3 class="fh-pcfh__feature" id="l9-tactical-master">Level 9: Tactical Master</h3>
...
<h3 class="fh-pcfh__feature" id="l11-two-extra-attacks">Level 11: Two Extra Attacks</h3>
<p>You can attack three times instead of once whenever you take the Attack action on your turn.</p>
<h3 class="fh-pcfh__feature" id="l13-studied-attacks">Level 13: Studied Attacks</h3>
...
<h4 class="fh-pcfh__feature" id="l3-remarkable-athlete">Level 3: Remarkable Athlete</h4>
...
<h4 class="fh-pcfh__feature" id="l7-additional-fighting-style">Level 7: Additional Fighting Style</h4>
<p>You gain another Fighting Style feat of your choice.</p>
<h4 class="fh-pcfh__feature" id="l10-heroic-warrior">Level 10: Heroic Warrior</h4>
...
<h4 class="fh-pcfh__feature" id="l15-superior-critical">Level 15: Superior Critical</h4>
...
**Your class list** <span class="fh-tag">FH</span> — Acrobatics · Animal Handling · Athletics · History · Insight · Intimidation · Persuasion · **Delve** · **Vigilance** · Survival.

> [!note] What Fate's Hand adds to the Fighter
...
> - **Grants** — none; no Fighter feature hands out points or opens Expertise early
> - **Subclasses** — as printed
> - **Arbitrated** — nothing; every Fighter rule stands as printed
