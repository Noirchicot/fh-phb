...
- Règles concernées : [`cadre.question-en-haut-a-droite`](portes/aide.md#cadre-question-en-haut-a-droite) · [`aide.bas-a-droite`](portes/aide.md#aide-bas-a-droite) · [`aide.entre-dans-la-rangee`](portes/aide.md#aide-entre-dans-la-rangee)
...
- Règles concernées : [`jeton.habit`](porteurs/jeton.md#jeton-habit)
...
- Règles concernées : [`collecteur.cote`](porteurs/collecteur.md#collecteur-cote) · [`collecteur.equipement-44`](porteurs/collecteur.md#collecteur-equipement-44)
...
- Règles concernées : [`panneau.largeur-cible`](general/panneau.md#panneau-largeur-cible) · [`panneau.compatibilite-360`](general/panneau.md#panneau-compatibilite-360) — les deux disent « 360 » dans leur énoncé. ⛔ Aucune règle ne porte le camp « 375 » : il ne vit que dans les gabarits mesurés (NORMES § 4 ter, § 2 ter, CADRES § 3).
- Mentionnée en passant dans : [`budget.gabarit-du-rang-b`](general/budget.md#budget-gabarit-du-rang-b) · [`budget.carte-r-est-un-dessin`](general/budget.md#budget-carte-r-est-un-dessin) — leur énoncé ne dit ni 360 ni 375 ; le 375 est dans les cotes qu'elles portent, pas dans ce qu'elles affirment.
...
- Mentionnée en passant dans : [`panneau.largeur-cible`](general/panneau.md#panneau-largeur-cible) · [`collecteur.quatre-par-ligne`](porteurs/collecteur.md#collecteur-quatre-par-ligne) · [`cadre.pied-76`](general/cadres.md#cadre-pied-76) — elles énoncent la cible 360, le maximum de quatre par ligne et la hauteur du pied, pas la largeur utile de la rangée.
- 👀 Non alertée mais à regarder : [`budget.trois-jetons-a-360`](general/budget.md#budget-trois-jetons-a-360) énonce *« la rangée dispose de 278 »* et ne porte aucune alerte. À Eric de dire si elle entre dans la dispute.
...
- Règles concernées : [`chevron.gauche-et-droite`](conduite/chevron.md#chevron-gauche-et-droite) · [`chevron.ecart-avec-le-code`](conduite/chevron.md#chevron-ecart-avec-le-code)
...
- Règles concernées : [`dropdown.habit`](commandes/dropdown.md#dropdown-habit) · [`dropdown.ecart-avec-le-code`](commandes/dropdown.md#dropdown-ecart-avec-le-code)
...
- Règles concernées : [`bouton.corps-du-texte`](commandes/bouton/mesures.md#bouton-corps-du-texte) · [`bouton.gabarit-des-deux-lignes`](commandes/bouton/mesures.md#bouton-gabarit-des-deux-lignes)
- Mentionnée en passant dans : [`bouton.porte-a-deux-ages`](commandes/bouton/fonctions.md#bouton-porte-a-deux-ages) — son énoncé décrit les deux âges d'une porte, il ne nomme aucun corps de texte.
...
- Mentionnée en passant dans : [`cadre.belt-toujours-visible`](conduite/ceinture.md#cadre-belt-toujours-visible) · [`socle.ce-qui-ne-se-redessine-jamais`](general/socle.md#socle-ce-qui-ne-se-redessine-jamais) · [`jeton.cote`](porteurs/jeton.md#jeton-cote) — elles énoncent respectivement que la ceinture n'est jamais couverte, que cinq nœuds ne se redessinent pas, et qu'un jeton mesure 87 × 48 ; le compte des étapes est dans leur *Valeur* ou leur *Pourquoi*.
- 👀 Non alertée mais à regarder : [`livre.rangee-encore-vide`](portes/livre.md#livre-rangee-encore-vide) énonce *« les dix écrans »* et *« cinq écrans sur dix »* et ne porte aucune alerte.
...
- Règles concernées : [`cadre.belt-toujours-visible`](conduite/ceinture.md#cadre-belt-toujours-visible) · [`budget.entree-r-sans-ceinture`](conduite/ceinture.md#budget-entree-r-sans-ceinture) · [`cadre.seuil-est-un-fs`](general/cadres.md#cadre-seuil-est-un-fs)
- Mentionnée en passant dans : [`cadre.fs-sortie-nommee`](general/cadres.md#cadre-fs-sortie-nommee) — son énoncé exige une sortie nommée ; que le FS recouvre la ceinture est dans son argument.
...
- Règles concernées : [`ecriture.corps-de-lecture-ne-se-met-pas-a-l-echelle`](general/ecriture.md#ecriture-corps-de-lecture-ne-se-met-pas-a-l-echelle) · [`budget.carte-r-est-un-dessin`](general/budget.md#budget-carte-r-est-un-dessin)
...
- Règles concernées : [`cadre.measure-unique`](general/cadres.md#cadre-measure-unique) · [`cadre.trois-largeurs`](general/cadres.md#cadre-trois-largeurs)
...
- Règles concernées : [`cadre.voile-de-la-dalle`](general/cadres.md#cadre-voile-de-la-dalle) · [`cadre.voile-des-blocs-interieurs`](general/cadres.md#cadre-voile-des-blocs-interieurs)
...
- Règles concernées : [`cadre.data-bleed`](general/cadres.md#cadre-data-bleed) · [`cadre.cadre-d-ecran-nu`](general/cadres.md#cadre-cadre-d-ecran-nu)
...
- Règles concernées : [`bouton.reserve-symetrique`](commandes/index.md#bouton-reserve-symetrique) — seule règle dont l'énoncé porte la réserve. ⛔ L'autre camp (le 60 d'Identity présenté comme un défaut) ne vit que dans NORMES § 4.
- Mentionnée en passant dans : [`cadre.regle-par-ressemblance-nomme-sa-source`](general/cadres.md#cadre-regle-par-ressemblance-nomme-sa-source) — le 60 contre 52 y est l'EXEMPLE d'une règle écrite par ressemblance, pas son énoncé.
...
- Règles concernées : [`jeton.trois-colonnes-toujours`](porteurs/jeton.md#jeton-trois-colonnes-toujours) · [`liste.trois-par-rangee-etait-un-accident`](general/listes.md#liste-trois-par-rangee-etait-un-accident) · [`panneau.reflux-oui-redimensionnement-non`](general/panneau.md#panneau-reflux-oui-redimensionnement-non)
...
- Règles concernées : [`popup.parle-on-ne-l-appuie-pas`](portes/popup.md#popup-parle-on-ne-l-appuie-pas) · [`popup.pile-et-pastilles`](portes/popup.md#popup-pile-et-pastilles) · [`popup.aiguilleur-nom-et-critere`](portes/popup.md#popup-aiguilleur-nom-et-critere)
...
- Règles concernées : [`cadre.tuile-ecart-4`](general/cadres.md#cadre-tuile-ecart-4) — seule règle dont l'énoncé porte un écart de 4. ⛔ La gouttière de 8 n'est l'énoncé d'aucune règle : elle vit dans NORMES § 1 quater et CADRES § 2 bis.
- Mentionnée en passant dans : [`budget.table-des-hauteurs`](general/budget.md#budget-table-des-hauteurs) · [`chevron.cout-en-largeur`](conduite/chevron.md#chevron-cout-en-largeur) — l'écart de 8 et le `--sp-4` des chevrons sont dans leurs *Valeur*, pas dans leur énoncé.
...
- Règles concernées : [`cadre.carte-hauteur-imposee`](general/cadres.md#cadre-carte-hauteur-imposee) · [`budget.carte-r-hauteur`](general/budget.md#budget-carte-r-hauteur)
