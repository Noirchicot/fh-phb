...
[`bouton.trois-verbes`](commandes/bouton/fonctions.md#bouton-trois-verbes) · [`bouton.back-next-n-ecrivent-jamais`](commandes/bouton/fonctions.md#bouton-back-next-n-ecrivent-jamais) · [`bouton.back-dans-les-sous-menus-seulement`](commandes/bouton/fonctions.md#bouton-back-dans-les-sous-menus-seulement) · [`bouton.done-et-next-jamais-ensemble`](commandes/bouton/fonctions.md#bouton-done-et-next-jamais-ensemble) · [`bouton.done-signe`](commandes/bouton/fonctions.md#bouton-done-signe) · [`bouton.done-gris-inacheve`](commandes/bouton/fonctions.md#bouton-done-gris-inacheve) · [`bouton.back-bleu-done-vert`](commandes/bouton/fonctions.md#bouton-back-bleu-done-vert) · [`bouton.i-changed-my-mind-jamais-seul`](commandes/bouton/fonctions.md#bouton-i-changed-my-mind-jamais-seul) · [`cadre.validate-disparu`](general/cadres.md#cadre-validate-disparu)
{ .lois-refs }
